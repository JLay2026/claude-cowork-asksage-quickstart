...
Write-Info "toolPolicy entries: $($toolPolicy.Count) ($($readTools.Count) allow, $($writeTools.Count) ask)"
...
Write-Ok "  Backup:        $bak"
Write-Ok "  Tool policies: $policyCount ($($readTools.Count) allow / $($writeTools.Count) ask)"
Write-Ok "=========================================="
Write-Ok ""
Write-Ok "NEXT STEPS:"
